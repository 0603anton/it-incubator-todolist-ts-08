...
import {AddTodoAC, ChangeFilterTodoAC, ChangeTodoAC, RemoveTodoAC, TodolistsReducer} from "./todolists-reducer";
...
test('correct filter of todolist should be changed', () => {
    ...
    const endState = TodolistsReducer(startState, ChangeFilterTodoAC(todolistId2,newFilter))
